...
//--- Actions
export const { reset, setStarshipToShow, setPilotsNumbers, setFilmsNumbers, setActiveKey, setFilmsNames, setPilotsNames } = starshipsSlice.actions
